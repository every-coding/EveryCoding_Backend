...
class UserRegisterAPI(APIView):
    ...
    def post(self, request):
        ...
        #print(data["realname"])
        user = User.objects.create(username=data["username"], email=data["email"], phonenum=data["phonenum"], realname=data["realname"], affiliation=data["affiliation"])
